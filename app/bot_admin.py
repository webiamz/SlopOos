...
<code>/set_balance_group @GroupLink</code>
...
━━━━━━━━━━━━━━━━━━━━━━"""
    ...
    async def handle_command(self, chat_id: int, text: str) -> None:
        ...
        try:
            ...
            # 🔥 FIX 2: STRICT EXACT MATCH FOR /SET_BAL 🔥
            ...
            # 🔥 FIX 2: STRICT EXACT MATCH FOR /ASSIGN 🔥
            elif command == "/assign":
                parts = args.split()
                ...
                # (Omitted strict match for test_send to save space, assuming it's rarely used)
    ...
    # 🔥 FIX 1: ACCOUNTS LIST IN GRID (Shows upto 100 Accounts) 🔥
