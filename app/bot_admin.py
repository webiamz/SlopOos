...
def main_keyboard() -> InlineKeyboardMarkup:
    return inline([
        [
            ...
            button("💰 Balances", "balances", "5258204546391351475", style="success"),
        ],
        [
            button("📈 Stats", "stats", "5258391025281408576", style="primary"),
            button("🤖 AI Guess", "guess", "5258093637450866522", style="primary"),
            button("🖥️ Status", "status", style="primary"),
        ],
        [
            button("🔗 Assign Account", "assign_start", "5260730055880876557", style="primary"),
        ...
        [
            button("⚙️ Settings", "settings", "5258096772776991776", style="primary"),
