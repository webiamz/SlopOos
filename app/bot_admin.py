...
E_NUM    = ce("\U0001F522", "5226513232549664618")
...
class AdminBot:
    def __init__(self, store: Store, notifier: BotNotifier, admin_ids: list[int], api_id: int, api_hash: str) -> None:
        ...
        self.last_error_notice: dict[str, float] = {}; self._admin_id_set: set[int] = set(); self.sync_admin_ids()
    ...
    def _build_guess(self, chat_id: int) -> str:
        ...
        trend_emoji = f"{ce('\U0001F4C8', '5244837092042750681')} Growth" if slope > 0 else (f"{ce('\U0001F4C9', '5246762912428603768')} Dropping" if slope < 0 else f"{E_ARROW} Stable")
