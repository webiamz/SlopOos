...
class AdminBot:
    ...
    # 🔥 NAYA: BLUE MENU BUTTON AUTO-SETUP 🔥
...
━━━━━━━━━━━━━━━━━━━━━━"""
    ...
    def start(self) -> None:
        ...
        self.set_bot_menu() # Initialize the Blue Menu Button
    ...
    def _build_guess(self, chat_id: int) -> str:
        ...
        trend_emoji = "↗️ Growth Tracking" if slope > 0 else ("↘️ Dropping" if slope < 0 else "➡️ Stable Speed")
        ...
        return (
            "🧠 Smart ML Prediction Model 🧠\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            f"⚡ Active Avg Speed: <code>{int(weighted_avg):,} Extols/day</code>\n"
            ...
            "(Modeled via Weighted Regression Math) 🚀"
        )
    ...
    async def handle_callback(self, callback: dict[str, Any]) -> None:
        ...
        try:
            ...
            elif data == "status": # 🔥 ADDED: Status Button Logic 🔥
    ...
    # 🔥 EDIT: STATUS METHOD (Now supports message_id for buttons) 🔥
    async def server_status(self, chat_id: int, message_id: int | None = None) -> None:
        ...
        # Changed to show main_keyboard so user can go back
        await self.reply(chat_id, text, main_keyboard(), message_id=message_id)
