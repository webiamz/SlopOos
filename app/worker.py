...
class TelegramWorker:
    ...
    def attach_handler(
        ...
        async def handler(event: events.NewMessage.Event) -> None:
            ...
            # 🔥 THE INVOICE FIX: Agar text khali hai, toh poore message ka Operation-Theatre khol do!
    ...
    async def handle_message(
        ...
        if "supported" in normalized:
            await self.notify_admins(f"👁️ **BOT KO ERROR MILA:**\n\n{text}")
        ...
        # 🔥 Euro/Custom Emoji Bypass Regex 🔥
